          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href = "<?php echo base_url(); ?>index.php/Dashboard" class="nav-link" > Dashboard Utama</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href = "<?php echo base_url(); ?>index.php/kredit" class="nav-link" >Daftar Kredit</a></li>
