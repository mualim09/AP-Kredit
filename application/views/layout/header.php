...
<head>
  ...
  <title>Managemen Perkreditan Safrizal Rahman</title>
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
          ...
          <div class="search-element">
            ...
            <div class="search-result">
              ...
              <div class="search-item">
                <a href="#">Daftar Perkreditan</a>
                <a href="#" class="search-close"><i class="fas fa-times"></i></a>
              </div>
              <div class="search-item">
                <a href="#">Mengenai Perkreditan</a>
                <a href="#" class="search-close"><i class="fas fa-times"></i></a>
              </div>
              <div class="search-item">
                <a href="#">Batas Pengajuan</a>
                <a href="#" class="search-close"><i class="fas fa-times"></i></a>
              </div>
              <div class="search-header">
                Result
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  ...
                  <div class="dropdown-item-desc">
                    <b>Safrizal</b>
                    <p>Web ini memudahkan pengguna untuk lebih berekspresi</p>
                    <div class="time">12 Hours Ago</div>
                  </div>
                </a>
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
              ...
              <div class="dropdown-list-content dropdown-list-icons">
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="dropdown-item-desc">
                    <b>Kepuasan anda akan terjamin dimanapun berada</b> 
                    <div class="time">10 Hours Ago</div>
                  </div>
                </a>
               <!--  <a href="#" class="dropdown-item">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Hi, Pelanggan </div></a>
