		...
		<input type="button" value="Click Me" style="float: right;"> -->
			...
			<form action="<?php echo base_url('index.php/'.$form_action); ?>" method="post">
				...
				<div class="form-group">
					...
					<input id="harga_cash" type="text" class="form-control datemask" placeholder="Tulis harga cash yang benar" name="harga_cash" value="<?php echo !empty($_POST['harga_cash']) ? set_value('harga_cash') : (!empty($kredit) ? $kredit['harga_cash'] : ""); ?>">
				</div>
				<div class="form-group">
