      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Perkreditan Web</span></h4>
            ...
            <form method="POST" action="<?php echo base_url('index.php/Login/auth');  ?>" class="needs-validation" novalidate="">
              ...
              <div class="form-group">
                ...
                <input  id="password" type="password" class="form-control" value=""<?php echo set_value('password'); ?>" name="password" tabindex="2" >
                <div class="invalid-feedback">
...
<!-- 
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; Rahman Group. Made with 💙💙💙 by Safrizal Rahman
              <div class="mt-2">
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?php echo base_url(); ?>/assets/img/unsplash/login-bg.jpg">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Hi</h1>
