            ...
            <!--         <h4>Default</h4>
                  ...
                  <div class="card-body">
                    ...
                    <div class="empty-state" data-height="600" style="height: 600px;">
                      ...
                      <h2 class="mt-0">Dengan kredit bisa meudahkan anda</h2>
                      <p class="lead">
												Jangan khawatir, dapatkan pengalaman terbaik anda untuk smartphone, dan lainya!"
												</p>
                    ...
                    <div class="empty-state" data-height="600" style="height: 600px;">
                      ...
                      <h2 class="mt-0">Dapatkan penawaran yang menarik </h2>
                      <p class="lead">
												Pengajuan yang mudah dan terpercaya.
                      </p>
                  <!--     <a href="#" class="btn btn-warning mt-4">Try Again</a>
                      <a href="#" class="mt-4 bb">Need Help?</a> -->
                    </div>
							...
							<!-- 		<div class="card-body">
                    <div class="empty-state" data-height="600" style="height: 600px;">
                      <img class="img-fluid" src="../assets/img/drawkit/tambahan.jpg" alt="image">
